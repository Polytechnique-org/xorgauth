...
class XorgScopeClaims(ScopeClaims):
    info_xorg_groups = (_("X Groups"), _("The list of the X Groups you belong to"))
    info_xorg_study_years = (_("Study year"), _("The year of your study at the Ecole polytechnique"))
    info_xorg_axid = (_("AX ID"), _("Your identification in AX directory"))
    info_xorg_axinfo = (
        _("AX subscription"),
    ...
    def scope_xorg_groups(self):
        ...
        dic = {"x_groups": [g.shortname for g in groups]}
        return dic
