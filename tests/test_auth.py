...
class AuthenticationTests(TestCase):
    def setUp(self):
        ...
        self.vaneau = User.objects.create_user(
            hrid="louis.vaneau.1829", main_email="louis.vaneau.1829@polytechnique.org", password="Depuis Vaneau!"
        )
    ...
    def test_password_set_form(self):
        ...
        c = Client()
        self.assertTrue(c.login(username="louis.vaneau.1829", password="Depuis Vaneau!"))
        form = xorgauth.forms.SetPasswordForm(
            user=self.vaneau,
            data={
    ...
    def test_password_change_form(self):
        ...
        c = Client()
        self.assertTrue(c.login(username="louis.vaneau.1829", password="Depuis Vaneau!"))
        form = xorgauth.forms.PasswordChangeForm(
            user=self.vaneau,
            data={
